...
module.exports = {
  ...
  plugins: [
    ...
    new HtmlWebpackPlugin({
      template: `${PAGES_DIR}/templates/cars.html.php`,
      filename: `./templates/cars.html.php`,
      inject: 'body',
      chunks: ['vendors', 'mainpage'],
    }),
    new HtmlWebpackPlugin({
      template: `${PAGES_DIR}/templates/logout.html.php`,
      filename: `./templates/logout.html.php`,
      inject: 'body',
      chunks: ['vendors', 'mainpage'],
    }),
    new HtmlWebpackPlugin({
    ...
    new HtmlWebpackPlugin({
      template: `${PAGES_DIR}/templates/my-orders.html.php`,
      filename: `./templates/my-orders.html.php`,
      inject: 'body',
      chunks: ['vendors', 'mainpage'],
    }),
    new HtmlWebpackPlugin({
      template: `${PAGES_DIR}/templates/edit-profile.html.php`,
      filename: `./templates/edit-profile.html.php`,
      inject: 'body',
      chunks: ['vendors', 'mainpage'],
    }),
    new HtmlWebpackPlugin({
      template: `${PAGES_DIR}/templates/410.html.php`,
      filename: `./templates/410.html.php`,
      inject: 'body',
      chunks: ['vendors', 'mainpage'],
    }),
