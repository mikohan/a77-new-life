...
<body>
                        ...
                        <div class="products-list__item">
                          <div class="product-card">
                            <div class="product-card__actions-list">
                              <button aria-label="Быстрый просмотр" class="product-card__action product-card__action--quickview" type="button" aria-label="Quick view" data-name="<?= $name ?>" data-price="<?= $price ?>" data-images='[<?= $d_arr ?>]' data-sku="<?= $sku ?>" data-catnumber="<?= $cat_number ?>" data-rating="<?= $rating ?>" data-brand="<?= $brand ?>" data-country="<?= $country ?>">
                                <svg width="16" height="16">
  ...
  <div id="add-vehicle-modal" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="vehicle-picker-modal modal-dialog modal-dialog-centered">
      <div class="modal-content">
        <button aria-label="Выбрать машину" type="button" class="vehicle-picker-modal__close"><svg width="12" height="12">
            <path d="M10.8,10.8L10.8,10.8c-0.4,0.4-1,0.4-1.4,0L6,7.4l-3.4,3.4c-0.4,0.4-1,0.4-1.4,0l0,0c-0.4-0.4-0.4-1,0-1.4L4.6,6L1.2,2.6
	c-0.4-0.4-0.4-1,0-1.4l0,0c0.4-0.4,1-0.4,1.4,0L6,4.6l3.4-3.4c0.4-0.4,1-0.4,1.4,0l0,0c0.4,0.4,0.4,1,0,1.4L7.4,6l3.4,3.4
	C11.2,9.8,11.2,10.4,10.8,10.8z" />
          </svg>
        ...
        <div class="vehicle-picker-modal__panel vehicle-picker-modal__panel--active">
          ...
          <div class="vehicle-picker-modal__actions">
            <button aria-label="Отменить" type="button" class="btn btn-sm btn-secondary vehicle-picker-modal__close-button">Cancel</button>
            <button aria-label="Добавить машину" type="button" class="btn btn-sm btn-primary">Add A Vehicle</button>
          </div>
        </div>
      </div>
    </div>
  ...
  <div id="vehicle-picker-modal" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="vehicle-picker-modal modal-dialog modal-dialog-centered">
      <div class="modal-content">
        <button aria-label="Закрыть окно" type="button" class="vehicle-picker-modal__close"><svg width="12" height="12">
            <path d="M10.8,10.8L10.8,10.8c-0.4,0.4-1,0.4-1.4,0L6,7.4l-3.4,3.4c-0.4,0.4-1,0.4-1.4,0l0,0c-0.4-0.4-0.4-1,0-1.4L4.6,6L1.2,2.6
	c-0.4-0.4-0.4-1,0-1.4l0,0c0.4-0.4,1-0.4,1.4,0L6,4.6l3.4-3.4c0.4-0.4,1-0.4,1.4,0l0,0c0.4,0.4,0.4,1,0,1.4L7.4,6l3.4,3.4
	C11.2,9.8,11.2,10.4,10.8,10.8z" />
          </svg>
        ...
        <div class="vehicle-picker-modal__panel vehicle-picker-modal__panel--active" data-panel="list">
          ...
          <div class="vehicles-list">
            <div class="vehicles-list__body">
              <label class="vehicles-list__item">
                ...
                <button aria-label="Удалть машину" type="button" class="vehicles-list__item-remove">
                  <svg width="16" height="16">
              ...
              <label class="vehicles-list__item">
                ...
                <button aria-label="Удалить машину" type="button" class="vehicles-list__item-remove">
                  <svg width="16" height="16">
                    <path d="M2,4V2h3V1h6v1h3v2H2z M13,13c0,1.1-0.9,2-2,2H5c-1.1,0-2-0.9-2-2V5h10V13z" />
                  </svg>
                </button>
          ...
          <div class="vehicle-picker-modal__actions">
            <button aria-label="Отменить" type="button" class="btn btn-sm btn-secondary vehicle-picker-modal__close-button">Cancel</button>
            <button aria-label="Добавить машину" type="button" class="btn btn-sm btn-primary" data-to-panel="form">Add A Vehicle</button>
          </div>
        </div>
        <div class="vehicle-picker-modal__panel" data-panel="form">
          ...
          <div class="vehicle-picker-modal__actions">
            <button aria-label="Вернуться к списку" type="button" class="btn btn-sm btn-secondary" data-to-panel="list">Back to list</button>
            <button aria-label="Добавить машину" type="button" class="btn btn-sm btn-primary">Add A Vehicle</button>
          </div>
        </div>
      </div>
    ...
    <div class="pswp__scroll-wrap">
      ...
      <div class="pswp__ui pswp__ui--hidden">
        <div class="pswp__top-bar">
          ...
          <button aria-label="Закрыть" class="pswp__button pswp__button--close" title="Close (Esc)"></button>
          <!--<button class="pswp__button pswp__button&#45;&#45;share" title="Share"></button>-->
          <button aria-label="Во весь экран" class="pswp__button pswp__button--fs" title="Toggle fullscreen"></button>
          <button aria-label="Увеличить" class="pswp__button pswp__button--zoom" title="Zoom in/out"></button>
        ...
        <button aria-label="Предидущий" class="pswp__button pswp__button--arrow--left" title="Previous (arrow left)"></button>
        <button aria-label="Следующий" class="pswp__button pswp__button--arrow--right" title="Next (arrow right)"></button>
