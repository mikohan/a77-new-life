  ...
  <div class="site" id="app">
            ...
            <nav class="breadcrumb block-header__breadcrumb" aria-label="breadcrumb">
              <ol class="breadcrumb__list breadcrumb__mobile">
                ...
                <?php foreach ($product['category'] as $category) : ?>
                  ...
                  if ($check_model) {
                    $link = $u->categoryCar($current_car_slug, $category['slug']);
                  } else {
                    ...
                    Video -->
                      ...
                      <div id="product" class="product-total">
                        <div class="product-left-row">
                          <img width="150" height="100" data-key="0" class="sm-img" src="images/tmb/001.webp" data-src="images/001-big.webp" />
                          <img width="150" height="100" data-key="1" class="sm-img" src="images/tmb/002.webp" data-src="images/002-big.webp" />
                          <img width="150" height="100" data-key="2" class="sm-img" src="images/tmb/003.webp" data-src="images/003-big.webp" />
                          <img width="150" height="100" data-key="3" class="sm-img" src="images/tmb/004.webp" data-src="images/004-big.webp" />
                          <img id="iframe-id" width="150" height="100" data-key="5" class="sm-img" src="images/tmb/youtube_sm.webp" data-src="images/youtube.webp" />
                        </div>
                      ...
                      <div class="product__subtitle">
                        <div class="status-badge status-badge--style--success product__fit status-badge--has-icon status-badge--has-text">
                          <div class="status-badge__body">
                            ...
                            <div class="status-badge__text">Если запчасть не подошла - Вернем Деньги!</div>
                          </div>
                        </div>
                      </div>
                    </div>
	...
	c0.4,0,0.8-0.3,0.8-0.8s-0.3-0.8-0.8-0.8h-2.5v-1.7H28c0.4,0,0.8-0.3,0.8-0.8s-0.3-0.8-0.8-0.8h-0.9v-1.7L29.6,21.9L29.6,21.9z" />
                            ...
                            <div class="shop-features__info">
                              ...
                              <div class="shop-features__item-subtitle">При Заказе от ₽ 8000
                              </div>
                            </div>
                          </li>
    ...
    c0.865,1.414,0.61,3.243-0.524,4.383L10.586,4.788C12.12,4.295,13.864,4.903,14.728,6.314L14.728,6.314z M14.728,6.314" />
                            ...
                            <div class="shop-features__info">
                              <div class="shop-features__item-title">Работаем 9-19/7</div>
                              <div class="shop-features__item-subtitle">Звоните!</div>
                            </div>
                          </li>
                          <li class="shop-features__divider" role="presentation"></li>
                          <li class="shop-features__item">
	...
	S40.1,35.1,40.3,35.1z" />
                            ...
                            <div class="shop-features__info">
                              <div class="shop-features__item-title">100% Безопасная Оплата</div>
                              <div class="shop-features__item-subtitle">Работаем через Яндекс и Сбербанк
                              </div>
                            </div>
                          </li>
                          <li class="shop-features__divider" role="presentation"></li>
	...
	s0.4-0.1,0.5-0.2l1.8-1.8l5.3,5.3c0.2,0.2,0.4,0.2,0.5,0.2c0.2,0,0.4-0.1,0.5-0.2c0.3-0.3,0.3-0.8,0-1.1L27.4,15.8z" />
                            ...
                            <div class="shop-features__info">
                              ...
                              <div class="shop-features__item-subtitle">Постоянным Клиентам
                              </div>
                            </div>
                          </li>
                          <li class="shop-features__divider" role="presentation"></li>
                          ...
                          <div class="typography">
                            <div class="product__tabs--delivery">
                              ...
                              <ul>
                                ...
                                <li>По другой причине.</li>
                                <li>Если запчасть имеет товарный вид и НЕ имеет следов установки. <a href="/garranty/" rel="nofollow">
