  ...
  <div class="products-list__item">
    <div class="product-card">
      <div class="product-card__actions-list">
        <button class="product-card__action product-card__action--quickview" type="button" aria-label="Quick view" data-name="<?= $name ?>" data-price="<?= $price ?>" data-images="<?= $d_arr ?>" data-tmbs="<?= $t_arr ?>" data-sku="<?= $sku ?>" data-catnumber="<?= $cat_number ?>" data-rating="<?= $rating ?>" data-brand="<?= $brand ?>" data-country="<?= $country ?>">
