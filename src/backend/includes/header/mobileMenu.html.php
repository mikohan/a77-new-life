<div class="mobile-menu">
  ...
  <div class="mobile-menu__body">
        ...
        <div class="mobile-menu__settings-list">
          ...
          <div class="mobile-menu__setting" data-mobile-menu-item>
            <button class="mobile-menu__setting-button" title="Currency" data-mobile-menu-trigger>
              ...
              <span class="mobile-menu__setting-title">Рубль</span>
              <span class="mobile-menu__setting-arrow"><svg width="6px" height="9px">
                  <path d="M0.3,7.4l3-2.9l-3-2.9c-0.4-0.3-0.4-0.9,0-1.3l0,0c0.4-0.3,0.9-0.4,1.3,0L6,4.5L1.6,8.7c-0.4,0.4-0.9,0.4-1.3,0l0,0C-0.1,8.4-0.1,7.8,0.3,7.4z" />
                </svg>
              </span>
	...
	C17.9,5.2,17.7,5,17.5,5H9.4C9.2,5,9,4.8,9,4.6V3.4C9,3.2,9.2,3,9.4,3h9.2C19.4,3,20,3.6,20,4.4z" />
              ...
              <span class="mobile-menu__indicator-counter count-cart">0</span>
            </span>
	...
	C-0.1,9.8-0.1,10.4,0.3,10.7z" />
          ...
          <li data-mobile-menu-item>
            <a href="<?= $u->delivery() ?>" class="" data-mobile-menu-trigger>
              Доставка
              <svg width="7" height="11">
                <path d="M0.3,10.7L0.3,10.7c0.4,0.4,0.9,0.4,1.3,0L7,5.5L1.6,0.3C1.2-0.1,0.7,0,0.3,0.3l0,0c-0.4,0.4-0.4,1,0,1.3l4,3.9l-4,3.9
	C-0.1,9.8-0.1,10.4,0.3,10.7z" />
          ...
          <li data-mobile-menu-item>
            <a href="<?= $u->blog() ?>" class="" data-mobile-menu-trigger>
              Блог
              <svg width="7" height="11">
                <path d="M0.3,10.7L0.3,10.7c0.4,0.4,0.9,0.4,1.3,0L7,5.5L1.6,0.3C1.2-0.1,0.7,0,0.3,0.3l0,0c-0.4,0.4-0.4,1,0,1.3l4,3.9l-4,3.9
	C-0.1,9.8-0.1,10.4,0.3,10.7z" />
	...
	C-0.1,9.8-0.1,10.4,0.3,10.7z" />
        ...
        <div class="mobile-menu__divider"></div>
        <a class="mobile-menu__contacts" href="tel:<?= TELEPHONE_FREE_LINK ?>">
          <div class="mobile-menu__contacts-subtitle">Звоните</div>
          <div class="mobile-menu__contacts-title"><?= TELEPHONE_FREE ?></div>
        </a>
      </div>
    </div>
  </div>
